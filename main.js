...
const ShowMsgs=()=>{
    ...
    if(arr1[0]==ph && arr1[1]==a.innerText){
        ...
        document.getElementById('images').style.backgroundImage = "url('css/BCA 2A-24/Morning.png')"
        ...
        document.getElementById('images').style.backgroundImage = "url('css/BCA 2A-24/Lunch.png')"
        document.getElementById('images').style.backgroundRepeat = "no-repeat"
        document.getElementById('images').style.backgroundSize = "cover"
        document.getElementById('images').innerText = " ";
    }
        ...
        document.getElementById('images').style.backgroundImage = "url('css/BCA 2A-24/Night.png')"
        document.getElementById('images').style.backgroundRepeat = "no-repeat"
        document.getElementById('images').style.backgroundSize = "cover"
        document.getElementById('images').innerText = " ";
    }
        ...
        document.getElementById('images').style.backgroundImage = "url('css/BCA 2A-24/Night1.png')"
        document.getElementById('images').style.backgroundRepeat = "no-repeat"
        document.getElementById('images').style.backgroundSize = "cover"
        document.getElementById('images').innerText = " ";
    }
